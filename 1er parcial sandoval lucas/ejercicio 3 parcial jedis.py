...
def buscarpadawans(buscado,jedis):
    print(f"los padawan de {buscado} son:")
    for i in range(len(jedis)):
        if jedis[i]["master"] is not None:
            if buscado in jedis[i]["master"]:
                print(jedis[i]["name"])
...
buscado="Ahsoka Tano"
criterio="name"
posicion=search(jedis,criterio,buscado)
if not None:
...
for jedi in range (len(jedis)):
    if jedis[jedi]["species"] == "Human" or jedis[jedi]["species"] == "Twi'lek":
        print(f'Nombre: {jedis[jedi]["name"]}, Especie: {jedis[jedi]["species"]}')
separar()
#punto e 
print("nombres que comienzan con A")
for jedi in range (len(jedis)):
    if jedis[jedi]["name"][0] == "A":
        print(jedis[jedi]["name"])
separar()
#punto f
print("jedis que usaron mas de un color de sable de luz")
for jedi in range (len(jedis)):
    if jedis[jedi]["lightsaber_color"] is not None:
        if "/" in jedis[jedi]["lightsaber_color"]:
            print(f'{jedis[jedi]["name"]} uso sables de luz de estos colores: {jedis[jedi]["lightsaber_color"]}')
separar()
#punto g
print("jedis que usaron sables de luz de color amarillo o violeta")
for jedi in range (len(jedis)):
    if jedis[jedi]["lightsaber_color"] is not None:
        if "Yellow" in jedis[jedi]["lightsaber_color"] or "Purple" in jedis[jedi]["lightsaber_color"]:
            print(f'{jedis[jedi]["name"]} uso: {jedis[jedi]["lightsaber_color"]}')
separar()
#punto h
buscado="Qui-Gon Jin"
buscarpadawans(buscado,jedis)
...
separar()
#punto i
print("personajes que tienen rank de Grand Master")
for jedi in range (len(jedis)):
    if jedis[jedi]["lightsaber_color"] is not None:
        if jedis[jedi]["rank"] == "Grand Master":
            print(jedis[jedi]["name"])
